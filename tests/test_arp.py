...
def test_arp_packet_generation():
...
def test_arp_announcements(mock_sendp):
...
@patch('netarmageddon.core.arp_keepalive.sendp')
def test_arp_cycles(mock_sendp):
...
def test_arp_cycles_count_and_exit(monkeypatch):
    """
